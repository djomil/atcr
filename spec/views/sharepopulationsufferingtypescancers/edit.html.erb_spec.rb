...
RSpec.describe "sharepopulationsufferingtypescancers/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit sharepopulationsufferingtypescancer form" do
    render

    assert_select "form[action=?][method=?]", sharepopulationsufferingtypescancer_path(@sharepopulationsufferingtypescancer), "post" do
